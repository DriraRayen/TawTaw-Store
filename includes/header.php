<?php
// Header component - checks if user is logged in and displays appropriate navigation
if (!isset($isLoggedIn)) {
   ...
   <nav>
      ...
      <span id="on">
         <?php if ($isLoggedIn): ?>
            ...
            <svg width="30" height="30" viewBox="0 0 30 30" fill="none" class="pointer" onclick="navigateToPage('cart')"
            ...
            <?php $userEmail = $_SESSION['user_email'] ?? 'Account'; ?>
            <div class="profile-menu-wrapper" tabindex="0">
               <svg width="42" height="40" viewBox="0 0 42 40" class="profile-logo" fill="none"
                  xmlns="http://www.w3.org/2000/svg" aria-label="User menu">
               ...
               <div class="profile-dropdown" role="menu">
                  ...
                  <button class="btx-red-reverse profile-action" type="button" onclick="handleLogout()">
                     Log out
                  </button>
               </div>
            </div>
